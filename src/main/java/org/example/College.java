...
public class College {
    ...
    public College(Student student, Teacher teacher) {   // constructor method does not create new objects; but getting/carrying the object references to the constructor
